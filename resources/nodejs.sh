#!/bin/bash
cd $1
touch /tmp/laboxtv_dep
echo "Début de l'installation"

echo 0 > /tmp/laboxtvn_dep
...
echo 80 > /tmp/laboxtv_dep
npm install request

# TODO
# change this to official node module
